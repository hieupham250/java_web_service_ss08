...
public class PaymentSlipController {
    ...
    public ResponseEntity<ApiResponse<List<PaymentSlip>>> getAll() {
        ...
        return ResponseEntity.ok(new ApiResponse<>(result, true, "Lay phieu chi thanh cong"));
    }
    ...
    public ResponseEntity<ApiResponse<PaymentSlip>> create(@RequestBody PaymentSlip paymentSlip) {
        ...
        return ResponseEntity.ok(new ApiResponse<>(saved, true, "Them phieu chi thanh cong"));
    }
    ...
    public ResponseEntity<ApiResponse<PaymentSlip>> update(@PathVariable Long id,
        ...
        return ResponseEntity.ok(new ApiResponse<>(updated, true, "Cap nhat phieu chi thanh cong"));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponse<Void>> delete(@PathVariable Long id) {
        paymentSlipService.delete(id);
        return ResponseEntity.ok(new ApiResponse<>(null, true, "Xoa phieu chi thanh cong"));
    }
